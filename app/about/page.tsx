...
import { Award, BookOpen, Target, BicepsFlexed, Smartphone } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "A ACELERA EAD é especialista em conectar pessoas ao mercado educacional, tornando possível a criação de novos polos EAD em todo o Brasil."
    },
    {
      icon: BicepsFlexed,
      title: "Vantagem Competitiva",
      description: "Com nosso modelo, você oferece cursos de instituições reconhecidas, com segurança jurídica, respaldo pedagógico e suporte completo para seu polo."
    },
    {
      icon: BookOpen,
      title: "Empreenda com Propósito",
      description: "Junte-se a uma rede sólida, amplie seu alcance e transforme vidas através da educação — com o apoio de quem entende do assunto."
    },
    {
      icon: Target,
      title: "Parceria que Gera Resultados",
      description: "Ofereça o que há de mais inovador em educação, com o respaldo de uma instituição sólida e de alta qualidade para garantir o sucesso."
    }
  ];
        ...
        <section id="sobre" className="py-20 bg-gradient-subtle">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <motion.h2 variants={fadeIn} className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                  Parceria que Gera
                ...
                <motion.p variants={fadeIn} className="text-muted-foreground mb-8 leading-relaxed">
                  A ACELERA EAD atua como intermediadora estratégica de negócios educacionais, conectando instituições e empreendedores interessados em expandir sua presença no ensino a distância.
                  Por meio de parcerias exclusivas, viabiliza a oferta de cursos de pós-graduação da Faculdade Iguaçu e cursos técnicos da Global Tec, possibilitando a implantação de polos credenciados para matrícula em todo o país.
                  Com essa integração, a ACELERA EAD impulsiona o crescimento de novos parceiros, ampliando o portfólio educacional com segurança, qualidade e suporte completo.Conexão que Transforma
                </motion.p>
          ...
          >
            <motion.div variants={fadeIn} className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Entre em contato conosco através do WhatsApp e tire todas as suas dúvidas sobre nossas parcerias educacionais.
              </p>
            </motion.div>
