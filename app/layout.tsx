...
export const metadata: Metadata = {
  ...
  description:
    "A Acelera EAD oferece cursos tecnológicos e especializações focados em acelerar sua carreira. Estude online e alcance seus objetivos profissionais conosco.",
